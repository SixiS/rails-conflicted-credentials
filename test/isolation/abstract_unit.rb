...
# From https://github.com/rails/rails/blob/main/railties/test/isolation/abstract_unit.rb
...
Module.new do
  ...
  sh "bundle exec rails new #{app_template_path} --skip-bundle --no-rc --quiet"
